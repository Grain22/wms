...
public final class HelloGrpc {
    ...
    private static volatile io.grpc.MethodDescriptor<Service.CheckReq,
            Service.Resp> getSayHelloMethod;
    ...
    @io.grpc.stub.annotations.RpcMethod(
            ...
            requestType = Service.CheckReq.class,
            responseType = Service.Resp.class,
            methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
    public static io.grpc.MethodDescriptor<Service.CheckReq,
            Service.Resp> getSayHelloMethod() {
            ...
            synchronized (HelloGrpc.class) {
                if ((getSayHelloMethod = HelloGrpc.getSayHelloMethod) == null) {
                    HelloGrpc.getSayHelloMethod = getSayHelloMethod =
                            io.grpc.MethodDescriptor.<Service.CheckReq, Service.Resp>newBuilder()
                                    .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
                                    .setFullMethodName(generateFullMethodName(SERVICE_NAME, "sayHello"))
                                    .setSampledToLocalTracing(true)
                                    .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                                            Service.CheckReq.getDefaultInstance()))
                                    .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                                            Service.Resp.getDefaultInstance()))
    ...
    public interface AsyncService {
         ...
         *
         */
        default void sayHello(Service.CheckReq request,
                              io.grpc.stub.StreamObserver<Service.Resp> responseObserver) {
    ...
    public static final class HelloStub
         ...
         *
         */
        public void sayHello(Service.CheckReq request,
                             io.grpc.stub.StreamObserver<Service.Resp> responseObserver) {
    ...
    public static final class HelloFutureStub
         ...
         *
         */
        public com.google.common.util.concurrent.ListenableFuture<Service.Resp> sayHello(
                Service.CheckReq request) {
        ...
        public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
            switch (methodId) {
                case METHODID_SAY_HELLO:
                    serviceImpl.sayHello((Service.CheckReq) request,
                            (io.grpc.stub.StreamObserver<Service.Resp>) responseObserver);
                    break;
                default:
